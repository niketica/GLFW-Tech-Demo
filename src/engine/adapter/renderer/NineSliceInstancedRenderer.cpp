...
namespace niketica::renderer {
    ...
    NineSliceInstancedRenderer::NineSliceInstancedRenderer(ITextureLoader* textureLoader)
    ...
    NineSliceInstancedRenderer::~NineSliceInstancedRenderer()
    {
    ...
    void NineSliceInstancedRenderer::clear()
    {
        spritesUI.clear();
    }

    void NineSliceInstancedRenderer::initQuad()
    {
    ...
    void NineSliceInstancedRenderer::render(const glm::mat4& projection, const glm::mat4& view)
    {
    ...
    void NineSliceInstancedRenderer::submitQuad(
        float x,
        float y,
        float w,
        float h,
    ...
    void NineSliceInstancedRenderer::submitUI(const unsigned int textureID, const niketica::component::Sprite& sprite, const glm::vec3& position, const glm::vec2& size,
        const float scale)
    {
        InstanceData data;
